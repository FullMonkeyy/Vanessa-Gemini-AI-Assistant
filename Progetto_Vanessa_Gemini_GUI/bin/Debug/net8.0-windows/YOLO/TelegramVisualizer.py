...
def TelegramVisualizer():
    print("processo di creazione telegram visualizer")
    if True:
        ...
        caricata=""
        perc=0.15
        print("Telegram visualizer online")
        while True:
            ...
            try:
                ...
                if "Cosa vedi telegram?" in response:
            ...
            print("INIZIO ACQUISIZIONE TELEGRAM")
                    ...
                    if score>0.75:
                        ...
                        if "person" in label:
                            ...
                            if DetectionREQUEST==False:
                                ...
                                PHOTOTAKER.PersonTOFACEIMAGE(cropped_image, response,0)
